...
const [dark,setDark]= useState(
  ...
  <div className="accordion-item" style={dark}>
    ...
    <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample" style={dark}> 
      <div className="accordion-body" >
    ...
    <button className="btn btn-primary" onClick={enableDark}>{btn}</button>
